#!/usr/bin/env python3
"""Build Auditor-ready evidence zip for SCIENCE_MONKEYS_READ_RESUME_ACTION_SCHEMA_INTEGRATION_001."""
...
OUT_DIR = ROOT / "temps"
OUT_NAME = "science_monkeys_read_resume_action_schema_integration_001_audit_pack.zip"
OPTIONAL_HELPER_REPORT = OUT_DIR / "science_monkeys_read_resume_action_schema_integration_001_helper_report.md"
...
INCLUDED_PATHS = [
    ...
    "docs/04_flows_and_spec_kit/SCIENCE_MONKEYS_READ_RESUME_ACTION_SCHEMA_INTEGRATION_001.md",
    "docs/04_flows_and_spec_kit/SCIENCE_MONKEYS_READ_RESUME_OPERATOR_COMMANDS_001.md",
    "docs/04_flows_and_spec_kit/SCIENCE_MONKEYS_READ_RESUME_GPT_ACTION_LIVE_SMOKE_PACKET_001.md",
    ...
    "worker/test_support/science_monkeys_read_resume_action_schema_policy_unit.py",
    "worker/test_support/science_monkeys_read_resume_action_schema_tripwire.py",
...
def main() -> int:
    ...
    manifest: dict[str, object] = {
        "slice": "SCIENCE_MONKEYS_READ_RESUME_ACTION_SCHEMA_INTEGRATION_001",
    ...
    with zipfile.ZipFile(out_path, "w", compression=zipfile.ZIP_DEFLATED) as zf:
        ...
        if OPTIONAL_HELPER_REPORT.exists():
            ...
            rel = "temps/science_monkeys_read_resume_action_schema_integration_001_helper_report.md"
            manifest["included_files"].append(rel)  # type: ignore[index]
            manifest["checksums"][rel] = sha256_bytes(data)  # type: ignore[index]
            zf.writestr(rel, data)
